...
def load_datasets(
    ...
    for group in datasets:
        ...
        for dataset in group:
            ...
            currclient_train.append(DataLoader(ds_train, batch_size=batch_size, shuffle=True, sampler=DistributedSampler(ds_train)))
            currclient_val.append(DataLoader(ds_val, batch_size=batch_size, shuffle=False, sampler=DistributedSampler(ds_val)))
        
        trainloaders.append(currclient_train)
        valloaders.append(currclient_val)
